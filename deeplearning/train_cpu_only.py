...
if __name__ == "__main__":
    ...
    parser.add_argument('--resume', default='', type=str, metavar='PATH',  # ./weight/cpu_only_b0_batch16.pth.tar
                        help='path to latest checkpoint (default: none)')
    parser.add_argument('--save_model_dir', default='./weight', type=str, metavar='PATH',
                        help='path to latest checkpoint (default: none)')
    parser.add_argument('--save_model_file_name', type=str, default="cpu_only_b0_batch16.pth.tar")
