...
if __name__ == "__main__":
    ...
    parser.add_argument('--resume', default='', type=str, metavar='PATH',
                        # ./weight/distributed_data_parallel_b0_bs_256.pth.tar
                        help='path to latest checkpoint (default: none)')
    parser.add_argument('--save_model_dir', default='./weight', type=str, metavar='PATH',
                        help='path to latest checkpoint (default: none)')
    parser.add_argument('--save_model_file_name', type=str, default="distributed_data_parallel_b0_bs_256.pth.tar")

    # model train parameter
    parser.add_argument('--batch_size', type=int, default=256)  # 128 까지는 검증 성공
