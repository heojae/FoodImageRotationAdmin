...
def main(args: argparse.Namespace):
    ...
    if torch.cuda.device_count() < 1:
        raise Exception("Please run other example, train_cpu_only")
...
if __name__ == "__main__":
    ...
    parser.add_argument('--resume', default='', type=str, metavar='PATH',
                        # ./weight/single_gpu_b0_bs_16.pth.tar
                        help='path to latest checkpoint (default: none)')
    parser.add_argument('--save_model_dir', default='./weight', type=str, metavar='PATH',
                        help='path to latest checkpoint (default: none)')
    parser.add_argument('--save_model_file_name', type=str, default="single_gpu_b0_bs_32.pth.tar")

    # model train parameter
    parser.add_argument('--batch_size', type=int, default=32)  # 128 까지는 검증 성공
